...
export const updateAppointment = async ({ appointmentId, userId, appointment, type }: UpdateAppointmentParams) => {
    ...
    try {
        ...
        ${ type === 'schedule' 
            ...
            : `We regret to inform you that your appointment with Dr.${appointment.primaryPhysician} has been cancelled due to this reason: ${appointment.cancellationReason!}.`
        }`
        
        await sendSmsNotifiation(userId, smsMessage);
...
export const sendSmsNotifiation = async ( userId: string, content: string ) => {
    try {
